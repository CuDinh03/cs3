...
<%
    ...
    request.setAttribute("users", userService.showAll());
%>
<html>
<head>
    <title>Info</title>
                    ...
                    <div class="card-body p-0">
                        <ul class="list-group list-group-flush rounded-3">
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                ...
                                <input class="text-muted mb-0" placeholder="github.com" name="gh" />
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                <i class="fab fa-twitter fa-lg" style="color: #55acee;"></i>
                                <input class="text-muted mb-0" placeholder="twitter.com" name="tw" />
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                <i class="fab fa-instagram fa-lg" style="color: #ac2bac;"></i>
                                <input class="text-muted mb-0" placeholder="instagram.com" name="insta" />
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                <i class="fab fa-facebook-f fa-lg" style="color: #3b5998;"></i>
                                <input class="text-muted mb-0" placeholder="fb.com" name="fb" />
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <input class="text-muted mb-0" value="${sessionScope['idUser']}" name="id" readonly >
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input class="text-muted mb-0" value=" ${sessionScope['nameuser']} " name="nameuser1" />
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input class="text-muted mb-0"value=" ${sessionScope['email']}" type="email" name="email1" />
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input class="text-muted mb-0" value=" ${sessionScope['contact']}" name="contact1"/>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input class="text-muted mb-0" value=" ${sessionScope['img']}" name="img1"/>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input class="text-muted mb-0" value=" ${sessionScope['address']}" name="address1" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4 mb-md-0">
                            <div class="card-body">
                                ...
                                %>
                                    <tr>
                                        <td><%= c.getNameProduct()%></td>
                                        <td><%= c.getPrice()%></td>
                                        <td><%= c.getCalo()%></td>
                                        <td><%= c.getQuantity()%></td>
                                        <td><img src="<%= c.getImg()%>" width="100" height="50" alt="loading"></td>
                                    </tr>
...
<footer class="py-5 bg-dark">
    <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Cu dep trai 2022</p></div>
</footer>
